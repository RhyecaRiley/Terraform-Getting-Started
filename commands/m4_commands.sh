...
terraform plan -var=billing_code="ACCT8675309" -var=project="web-app" -var=aws_access_key="${TF_VAR_aws_access_key}" -var=aws_secret_key="${TF_VAR_aws_secret_key}" -out m4.tfplan
